...
- Každý nový soubor je samostatný koncept (1 entita = 1 soubor).
- UPRAVY OBJEKTŮ: vždy uveď, který Příběh si změnu vynutil.
- NOVÉ PŘÍBĚHY: přilož seznam objektů, které musí existovat nebo být upraveny (jako text v PR).
- NOVÉ LEGENDY: vysvětli, jak se vztahují k existujícím Příběhům/Objektům.

Zásada:
- PŘÍBĚH = „zamrzlý“ text. OBJEKT = „živý“ popis se stavem a dějinami.
- LEGENDY = rámec, který se rozšiřuje pomaleji; nesmí popřít schválené Příběhy.
